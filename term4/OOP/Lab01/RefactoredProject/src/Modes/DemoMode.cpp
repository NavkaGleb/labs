...
namespace RefactoredProject {
    ...
    DemoMode_Impl::DemoMode_Impl()
        : m_InputStream(std::ifstream("../media/DemoMode/Commands.txt"))
        , m_Command(0) {

        LocationManager::Create(m_InputStream, std::cout);
        MonsterManager::Create(m_InputStream, std::cout);
    }
    ...
    void DemoMode_Impl::UpdateCommand() {
        ...
        m_InputStream >> m_Command;
    }

    bool DemoMode_Impl::ParseCommand() const {
        switch (m_Command / 20) {
