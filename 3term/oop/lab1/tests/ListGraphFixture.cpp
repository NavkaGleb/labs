...
protected:
    // variables
    ng::ListGraph<std::string, double>* _graph;
    ...
    void CreateGraph(bool directed, bool weighed) {
        ...
        this->_graph = new ng::ListGraph<std::string, double>(directed, weighed);
...
TEST_F(ListGraphFixture, Dijkstra) {
